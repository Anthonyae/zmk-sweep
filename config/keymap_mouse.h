...
#define MOVE_UP_DEAD MOVE_VERT(-U_MOUSE_MOVE_MAX_DEAD)
#define MOVE_DOWN_DEAD MOVE_VERT(U_MOUSE_MOVE_MAX_DEAD)
#define MOVE_LEFT_DEAD MOVE_HOR(-U_MOUSE_MOVE_MAX_DEAD)
#define MOVE_RIGHT_DEAD MOVE_HOR(U_MOUSE_MOVE_MAX_DEAD)
