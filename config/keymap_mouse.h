...
#define SCROLL_UP_FAST MOVE_Y(U_MOUSE_SCROLL_MAX_FAST)
#define SCROLL_DOWN_FAST MOVE_Y(-U_MOUSE_SCROLL_MAX_FAST)
#define SCROLL_LEFT_FAST MOVE_X(-U_MOUSE_SCROLL_MAX_FAST)
#define SCROLL_RIGHT_FAST MOVE_X(U_MOUSE_SCROLL_MAX_FAST)
...
#define SCROLL_UP_MEDIUM MOVE_Y(U_MOUSE_SCROLL_MAX_MEDIUM)
#define SCROLL_DOWN_MEDIUM MOVE_Y(-U_MOUSE_SCROLL_MAX_MEDIUM)
#define SCROLL_LEFT_MEDIUM MOVE_X(-U_MOUSE_SCROLL_MAX_MEDIUM)
#define SCROLL_RIGHT_MEDIUM MOVE_X(U_MOUSE_SCROLL_MAX_MEDIUM)
...
#define SCROLL_UP_SLOW MOVE_Y(U_MOUSE_SCROLL_MAX_SLOW)
#define SCROLL_DOWN_SLOW MOVE_Y(-U_MOUSE_SCROLL_MAX_SLOW)
#define SCROLL_LEFT_SLOW MOVE_X(-U_MOUSE_SCROLL_MAX_SLOW)
...
#define SCROLL_UP_CRAWL MOVE_Y(U_MOUSE_SCROLL_MAX_CRAWL)
#define SCROLL_DOWN_CRAWL MOVE_Y(-U_MOUSE_SCROLL_MAX_CRAWL)
#define SCROLL_LEFT_CRAWL MOVE_X(-U_MOUSE_SCROLL_MAX_CRAWL)
#define SCROLL_RIGHT_CRAWL MOVE_X(U_MOUSE_SCROLL_MAX_CRAWL)
...
#define SCROLL_UP_DEAD MOVE_Y(U_MOUSE_SCROLL_MAX_DEAD)
#define SCROLL_DOWN_DEAD MOVE_Y(-U_MOUSE_SCROLL_MAX_DEAD)
#define SCROLL_LEFT_DEAD MOVE_X(-U_MOUSE_SCROLL_MAX_DEAD)
#define SCROLL_RIGHT_DEAD MOVE_X(U_MOUSE_SCROLL_MAX_DEAD)
